...
namespace SchoolAdministration.Services.Identity.Application.Common.Exceptions
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"User Name '{userName}' is already exists." }; }
